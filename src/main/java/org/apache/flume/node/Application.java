...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (!isZkConfigured) {
          logger.error("Please config zookeeper!");
          System.exit(0);
      }
      ...
      //检查license
      String node = ZooKeeperUtils.checkAuth(zkConnectionStr);
      if (node == null) {
        System.exit(0);
      }
      ZooKeeperUtils.registerWatcher(node);
      //记录配置文件使用者
      ZooKeeperUtils.recordConfigUsed(baseZkPath+"/"+agentName);
